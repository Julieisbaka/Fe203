...
- **FE083**: Changed in `0.0.3`. Fixed to no longer trigger on ordinary `.find(` iterator/string
...
- **FE083**: Changed in `0.1.5`. Also looks at nearby regex builder statements, so validation-style
